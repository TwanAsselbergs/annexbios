...
--
-- Host: localhost
-- Generation Time: Sep 17, 2024 at 01:39 PM
...
INSERT INTO `stoelen` (`id`, `rij`, `stoel_Nr`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
--
ALTER TABLE `klanten`
  MODIFY `klant_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
