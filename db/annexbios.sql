...
--
-- Host: localhost
-- Generation Time: Sep 19, 2024 at 09:09 PM
...
(22, 'twan', 'test', 'test@nl.nl', 655013388),
(23, 'twan', 'test', 'test@nl.nl', 655013388);
...
(39, 22, 10, 10, 'Blink Twice', '2024-09-19', 22),
(40, 22, 10, 9, 'Blink Twice', '2024-09-19', 22),
(41, 22, 8, 9, 'Blink Twice', '2024-09-19', 22),
(42, 23, 10, 10, 'Blink Twice', '2024-09-19', 23),
(43, 23, 10, 9, 'Blink Twice', '2024-09-19', 23),
(44, 23, 8, 9, 'Blink Twice', '2024-09-19', 23);
...
INSERT INTO `stoelen` (`id`, `rij`, `stoel_Nr`, `bezet`) VALUES
(1, 1, 1, 0),
(2, 1, 2, 0),
(3, 1, 3, 0),
(4, 1, 4, 0),
...
--
ALTER TABLE `klanten`
  MODIFY `klant_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
